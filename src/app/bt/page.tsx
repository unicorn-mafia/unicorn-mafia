        ...
        <div className="border border-black p-8 md:p-12 text-center space-y-8">
          ...
          <div className="pt-6 border-t border-gray-200 space-y-6">
            <div className="flex flex-col items-center gap-4">
              <p className="text-base md:text-lg font-body text-gray-500">Built with</p>
              ...
              <p className="text-xs font-body text-gray-500">
                By <a href="https://www.linkedin.com/in/joshwarwick/" target="_blank" rel="noopener noreferrer" className="text-black hover:underline">Josh Warwick</a>
              </p>
            </div>

            <div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                <a href="https://wassist.app/" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center p-4 rounded-lg border border-gray-200 bg-gray-50/50 hover:border-gray-300 hover:bg-gray-100/50 transition-colors text-center">
                  <span className="flex items-center justify-center w-10 h-10 rounded-full bg-green-100 text-green-700 mb-2 group-hover:bg-green-200 transition-colors" aria-hidden>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>
                  </span>
                  <span className="text-sm font-medium text-gray-800">Support</span>
                  <span className="text-xs text-gray-500 mt-0.5">24/7 resolution</span>
                </a>
                <a href="https://wassist.app/" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center p-4 rounded-lg border border-gray-200 bg-gray-50/50 hover:border-gray-300 hover:bg-gray-100/50 transition-colors text-center">
                  <span className="flex items-center justify-center w-10 h-10 rounded-full bg-green-100 text-green-700 mb-2 group-hover:bg-green-200 transition-colors" aria-hidden>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>
                  </span>
                  <span className="text-sm font-medium text-gray-800">Sales</span>
                  <span className="text-xs text-gray-500 mt-0.5">Recommend & sell</span>
                </a>
                <a href="https://wassist.app/" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center p-4 rounded-lg border border-gray-200 bg-gray-50/50 hover:border-gray-300 hover:bg-gray-100/50 transition-colors text-center">
                  <span className="flex items-center justify-center w-10 h-10 rounded-full bg-green-100 text-green-700 mb-2 group-hover:bg-green-200 transition-colors" aria-hidden>
                  ...
                  <span className="text-xs text-gray-500 mt-0.5">Qualify & convert</span>
                </a>
              </div>
