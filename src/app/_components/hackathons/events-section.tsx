...
const EventCard = ({
  ...
  return (
    <div className="relative flex w-full min-w-0 flex-col items-stretch">
      {/* Card — fixed 3:4 aspect so every face matches across the grid */}
      <motion.div
        ref={cardRef}
        className="relative aspect-[3/4] w-full max-w-full shrink-0 select-none cursor-pointer"
        style={{
          perspective: 800,
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {/* Title header — reserved height so image band stays equal on every card */}
                  <div className="relative z-[45] shrink-0 px-3 pt-3 pb-1">
                    <div
                      className="relative flex min-h-[3.25rem] items-center justify-between gap-2 px-2.5 py-2"
                      style={{
                        background:
