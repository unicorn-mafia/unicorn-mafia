...
export default function Hero() {
  return (
    <div className="flex flex-col items-center justify-between w-full h-full pt-12 pb-24">
      ...
      <div className="grid grid-cols-2 w-full text-3xl">
        ...
        <div className="flex flex-col font-source font-medium pl-12 text-black gap-4 text-justify">
